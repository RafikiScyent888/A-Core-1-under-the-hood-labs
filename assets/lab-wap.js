...
const SITES = [
  ...
  /* FIVE MORE SITES, and the named-scenario picker is what asked for them.

     Putting the jobs in a list a student chooses from made it visible that
     this lab had FOUR customers, measured across 400 seeds — so the list
     could only ever offer four, and a student who did them all had done
     the lab. Four was invisible while the scenario arrived by dice roll.

     Each of these leads with a DIFFERENT dominant interference, because
     the six sources are meant to stack and the skill is working out which
     one is on top. A fifth site whose answer is another microwave is a
     fifth site nobody learns anything new from. */
  { who: "Marchbank Primary School", size: "Mid-Market",
    said: ["the year six room at the top of the stairs is unusable and the rest of the school is fine",
           "the tablets all went in at once last term, thirty of them in one room",
           "there is a stack of old access points in the store that nobody ever turned off"] },
  { who: "Pemberton Care Home", size: "Small Business",
    said: ["the residents' lounge is the problem and the office next to it is perfect",
           "the nurse call handsets are the old cordless ones on their own base stations",
           "there is a fish tank the length of one wall and a mirrored corridor"] },
  { who: "Craven Row Dental Laboratory", size: "Small Business",
    said: ["it goes for a minute or two at a time, several times an hour, and then comes back",
           "the technicians warm their lunch whenever they like, there is no set break",
           "the benches are steel and the whole workshop is one open room"] },
  { who: "Ashgrove Veterinary Hospital", size: "Mid-Market",
    said: ["the kennels block at the back has never worked properly",
           "it is a separate building joined by a corridor, and the corridor is glazed",
           "the x-ray room between them is lead lined, which somebody said might matter"] },
  { who: "Thornbury Self Storage", size: "Small Business",
    said: ["the office is fine and the corridors between the units are dead",
           "every unit is a steel box and the doors are steel shutters",
           "the lights in the corridors are the long fluorescent tubes and two of them hum"] }
];
